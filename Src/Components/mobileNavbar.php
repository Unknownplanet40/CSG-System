...
<div class="b_navbar d-lg-none bg-body bg-blur-5 bg-opacity-25" id="b_Navbar">
        <div class="row h-100 item-parent">
            <div class="col-3">
                <a class="col-Items <?php echo $McurrentPage == 'Feed.php' ? 'nav-active' : ''; ?>" <?php echo $McurrentPage != 'Feed.php' ? "onclick='window.location.href=\"$MFeed\"'" : ''; ?>
                id="b_ItemNav_Log">
            ...
            <div class="col-3">
                <a class="col-Items <?php echo $McurrentPage == 'Profile.php' ? 'nav-active' : ''; ?>" <?php echo $McurrentPage != 'Profile.php' ? "onclick='window.location.href=\"$MProfile\"'" : ''; ?>
                id="b_ItemNav_Reg">
                    <svg width="32" height="32">
            ...
            <div class="col-3">
                <a class="col-Items <?php echo $McurrentPage == 'Dashboard.php' ? 'nav-active' : ''; ?>" <?php echo $McurrentPage != 'Dashboard.php' ? "onclick='window.location.href=\"$MDashboard\"'" : ''; ?>
                    id="b_ItemNav_For">
                    <svg width="32" height="32">
